    ...
    <>
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64">
          <div className="flex flex-col flex-grow bg-dark-800/40 backdrop-blur-md border-r border-dark-700/50 pt-5 pb-4 overflow-y-auto">
            {/* Logo */}
            <Link to="/" className="flex items-center justify-center flex-shrink-0 p-4 mx-4 my-4 bg-dark-900/50 backdrop-blur-md rounded-2xl border border-dark-700/50 shadow-xl relative overflow-hidden group cursor-pointer hover:border-primary-500/50 transition-all duration-300 z-50">
      ...
      {/* Mobile sidebar */}
      <div className={`lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-dark-800/80 backdrop-blur-lg border-r border-dark-700/50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
        <div className="flex flex-col h-full">
          {/* Header with close button */}
          <div className="flex items-center justify-between p-4 border-b border-dark-700/50 bg-dark-900/40">
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-md text-dark-400 hover:text-dark-100 hover:bg-dark-700/50"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
